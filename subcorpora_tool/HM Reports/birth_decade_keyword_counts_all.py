...
def main():
    ...
    women_totals = [all_women, non_HM_AA_women, HM_women]

    for decade_pair in decade_pairs:
        ...
        for i, r in df.iterrows():
            if pd.isnull(r["birth_decade"]) or (r["birth_decade"] != decade_pair[0] and r["birth_decade"] != decade_pair[1]-10 and \
                    r["researcher_assumed_birth_decade"] != decade_pair[0] and r["researcher_assumed_birth_decade"] != decade_pair[1]-10):
                continue
            ...
            if r["project_file_name"] not in keyword_to_files_dict["All"][0]: #All
                ...
                elif r["identified_race"] == "Black or African American" or r["researcher_assumed_race"] == "Black or African American" and\
        ...
        birth_cohort_size = len(keyword_to_files_dict["All"])
        ...
        new_csv_name = "birth_decade_keyword_count_and_percent_" + str(decade_pair[0]) + "-" + str(decade_pair[1]) + ".csv"
